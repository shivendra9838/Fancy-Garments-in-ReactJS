    ...
    <div>
      ...
      <div className='my-10 flex flex-row justify-center gap-10 mb-28'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <p className='text-gray-500'>The Souled Store, <br/>Civil Line, Prayagraj, 211001</p>
          <p className='text-gray-500'>Tel: +918318407559 <br/>Email: Anupampatel21661@gmail.com</p>
